...
*Clarity*
- The new graph adopted a combination of violin, boxplot and line chart, instead of line chart to reveal the distribution of joviality for residents, and we use three charts to show the influence of age and education level on Joviality and influence of age on education level respectively, which is easier to detect the trend when considering each aspect.
- Data source and explanation of the data are added to provide more information.
- The mark of x-axis and y-axis is easy to understand
*Aesthetic*
- The color match is clean and easily readable to the audience.
- Positions of title, y-axis are improved
- The plot backgroud is clearer and easier to detect changes.
...
- Derived values reveal more interesting patterns than absolute values.For example, the propotion of each age group

- Pre-attentive processing is important for design of visualizations
